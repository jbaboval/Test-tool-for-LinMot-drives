...
if __name__ == '__main__':
    ...
    print(lin.move_to_pos(0, velocity=10000))
    time.sleep(0.5)
    print(lin.move_to_pos(10, velocity=10000))
    time.sleep(0.5)
    print(lin.move_to_pos(50, velocity=10000))
    time.sleep(0.5)
    print(lin.move_to_pos(100, velocity=10000))
    time.sleep(0.5)
    print(lin.move_to_pos(150, velocity=10000))
    time.sleep(0.5)
    print(lin.move_to_pos(100, velocity=10000))
    time.sleep(0.5)
    print(lin.move_to_pos(50, velocity=10000))

    print(lin.move_to_pos(0, velocity=1000000, acceleration=100000, deceleration=100000))
    time.sleep(0.5)
    print(lin.move_to_pos(10, velocity=1000000, acceleration=100000, deceleration=100000))
    time.sleep(0.5)
    print(lin.move_to_pos(50, velocity=1000000, acceleration=100000, deceleration=100000))
    time.sleep(0.5)
    print(lin.move_to_pos(100, velocity=1000000, acceleration=100000, deceleration=100000))
    time.sleep(0.5)
    print(lin.move_to_pos(150, velocity=1000000, acceleration=100000, deceleration=100000))
    time.sleep(0.5)
    print(lin.move_to_pos(100, velocity=1000000, acceleration=100000, deceleration=100000))
    time.sleep(0.5)
    print(lin.move_to_pos(50, velocity=1000000, acceleration=100000, deceleration=100000))
